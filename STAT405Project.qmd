...
mtext("Figure 5: Age Group and Distribtion", side = 1, line = 4, adj = -0.1, cex = 0.7, font = 3, col = "black")
...
mtext("Figure 6: Gender vs. Age Group Heatmap", side = 1, line = 4, adj = -0.1, cex = 0.7, font = 3, col = "black")
