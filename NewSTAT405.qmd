...
grid.text("Less", x = grad_key_x-0.015, y = grad_key_y - (grad_key_height / 2) - 0.02, just = "centre")
grid.text("More", x = grad_key_x-0.015, y = grad_key_y + (grad_key_height / 2) + 0.02, just = "centre")
...
get_color <- function(count, max_count) {
  ...
  colors <- colorRampPalette(c("blue", "purple","purple","red"))(100)  # Blue for less, Red for more
...
draw_circle(0.85,.17, .02)
draw_circle(0.85,.22, .025)
draw_circle(0.85,.28, .03)
draw_circle(0.85,.36, .04)
draw_circle(0.85,.45, .05)
draw_circle(0.85,.55, .0575)
draw_circle(0.85,.67, .077)
