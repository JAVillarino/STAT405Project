...
```
<p align = "center">
[Figure 1b: Table of Linear Regression Modeling Data]
</p>
...
```{r, warning = FALSE, fig.height = 15, fig.width = 50}
#| echo: false
...
legend(1, 1, 1, legend = levels(cleaned_data$`Payment Typology 1`), fill = rainbow(length(payments)), cex = 3)
...
```
<p align = "center">
[Figure 3: Pie Chart of Payment Distribution]
</p>
...
```
<p align = "center">
[Figure 4:Trends of Total Charges and Legnth of Stay ]
</p>
...
```
<p align = "center">
[Figure 5: Age Group Distribution of Patients in New York]
</p>
...
## Plot 6: Stacked Bar Chart by Gender and Race
...
plot7 + ggtitle("Stacked Bar Chart by Gender and Race")

```
<p align = "center">
[Figure 6: Stacked Bar Chart by Race and Gender]
</p>
...
## Plot 7: Boxplots on the Total Costs on the Risk of Mortality
...
## Plot 8: Violin Plot Comparing New York City and Western New York's Severity of Illness
...
## Plot 10: Facet Density Plots of Total Cost per Age-Group Buckets
